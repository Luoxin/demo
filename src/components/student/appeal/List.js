...
function Delete(value) {
    axios.post("https://xihui.luoxin.live/api/appeal/recall", {
...
export default function List() {
    ...
    useEffect(() => {
        let optionsSelect = []
        axios.post("https://xihui.luoxin.live/api/examiner/appeal/list", {
            options: {
        ...
        axios.post("https://xihui.luoxin.live/api/reviewer/appeal/list", {
            options: {
                options: optionsSelect,
                offset: 0,
                limit: 6,
    ...
    return (
        <div>
            <div style={{
                ...
                <Checkbox.Group style={{marginLeft: '240px', marginRight: '20px', marginBottom: '20px'}}
                                options={options} defaultValue={['State']} onChange={onSelect}/>
