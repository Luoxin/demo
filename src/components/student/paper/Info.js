...
export default function PaperInfo() {
    ...
    useEffect(() => {
        axios.post("https://xihui.luoxin.live/api/examiner/paper/get", {
            id: state.paper.id,
        }, {
            headers: {
    ...
    const handleOk = () => {
        ...
        axios.post("https://xihui.luoxin.live/api/appeal/add", {
    ...
    return (
        <div style={{
            ...
            <Button style={{marginLeft: '400px', marginTop: '30px'}} onClick={showModal}
                    type='primary'>提出申诉</Button>
            <Modal
                title="申诉理由"
                open={open}
                onOk={handleOk}
