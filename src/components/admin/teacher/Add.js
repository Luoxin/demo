...
const onFinish = (values: any) => {
    ...
    console.log(md5(psw));
    axios.post("https://xihui.luoxin.live/api/admin/teacher/add", {
        teacher: {
...
export default function ExamInfo() {
    ...
    return (
        <div>
            ...
            >
                <Form.Item name={['teacher', 'teacher_id']} rules={[{required: true, message: '请输入教师编号!'}]}
                           label="教师编号">
                    <Input/>
                </Form.Item>
                ...
                <Form.Item name={['teacher', 'email']} rules={[{required: true, type: "email", message: '请输入邮箱!'}]}
                           label="邮箱">
                    <Input/>
                </Form.Item>
