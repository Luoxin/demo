...
export default function Info() {
    ...
    const onFinish = (values: any) => {
        console.log(values);
        axios.post("https://xihui.luoxin.live/api/admin/teacher/set", {
            teacher: {
    ...
    return (
        <div style={{
            ...
            >
                ...
                <Form.Item name={['teacher', 'name']} label="姓名" rules={[{required: true, message: '请输入姓名!'}]}
                           initialValue={state.teacher.name}>
                    <Input/>
                </Form.Item>
                <Form.Item name={['teacher', 'email']} label="邮箱"
                           rules={[{required: true, type: "email", message: '请输入邮箱!'}]}
                           initialValue={state.teacher.email}>
                    <Input/>
                </Form.Item>
