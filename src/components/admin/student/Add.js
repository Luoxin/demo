...
const onFinish = (values: any) => {
    ...
    console.log(md5(psw));
    axios.post("https://xihui.luoxin.live/api/admin/student/add", {
        student: {
...
export default function ExamInfo() {
    ...
    return (
        <div>
            ...
            >
                <Form.Item name={['student', 'student_id']} rules={[{required: true, message: '请输入编号!'}]}
                           label="学生编号">
                    <Input/>
                </Form.Item>
                ...
                <Form.Item name={['student', 'email']} rules={[{required: true, type: "email", message: '请输入邮箱!'}]}
                           label="邮箱">
                    <Input/>
                </Form.Item>
