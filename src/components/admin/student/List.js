...
function Delete(value) {
    axios.post("https://xihui.luoxin.live/api/admin/student/del", {
        id: parseInt(value),
    }, {
        headers: {
...
export default function List() {
    ...
    useEffect(() => {
        axios.post("https://xihui.luoxin.live/api/admin/student/list", {
            options: {
                options: [],
                offset: 0,
                limit: 6,
    ...
    Reset = (value) => {
        axios.post("https://xihui.luoxin.live/api/reset/password", {
            role_type: 3,
            username: value,
    ...
    return (
        <div>
            ...
            {/*<Button style={{marginLeft:'30px',marginRight:'30px'}} type='primary' onClick={onImport}>导入</Button>*/}
            <Button style={{marginLeft: '30px', marginRight: '30px'}} type='primary' onClick={AddPaper}>添加</Button>
            <Checkbox.Group style={{marginLeft: '240px', marginRight: '20px', marginBottom: '20px'}} options={options}
