...
import {Button, Input, message, Pagination, PaginationProps, Space, Table} from 'antd';
...
function Delete(value) {
    axios.post("https://xihui.luoxin.live/api/exam/del", {
        id: value,
    }, {
        headers: {
...
export default function List() {
    ...
    useEffect(() => {
        axios.post("https://xihui.luoxin.live/api/exam/list", {
            options: {
                options: [],
                offset: 0,
                limit: 6,
    ...
    const handleOk = () => {
        ...
        axios.post("https://xihui.luoxin.live/api/exam/add", {
            exam: {
                name: exam,
            }
        }, {
    ...
    return (
        <div>
            <div style={{
                ...
                <Input style={{width: '220px', marginRight: '20px', marginLeft: '540px',}} id='name'
                       placeholder="根据考试名称查询"/>
