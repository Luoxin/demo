...
function Delete(value) {
    axios.post("https://xihui.luoxin.live/api/paper/del", {
        id: parseInt(value),
    }, {
        headers: {
...
export default function Info() {
    ...
    const onFinish = (values: any) => {
        console.log(values);
        axios.post("https://xihui.luoxin.live/api/paper/add", {
    ...
    useEffect(() => {
        ...
        console.log(pid)
        axios.post("https://xihui.luoxin.live/api/teacher/paper/get", {
            id: pid,
        }, {
            headers: {
                "X-Session-Id": cookieData.token
    ...
    function uploadImg() {
        ...
        reader.onload = (e) => {
            ...
            axios.post("https://xihui.luoxin.live/api/resource/put", {
    ...
    return (
        <div>
            ...
            >
                <Form.Item name={['paper', 'examiner_id']} rules={[{required: true, message: '请输入考试人编号!'}]}
                           label="考试人编号">
                    <Input id='examiner_id'/>
                </Form.Item>
                <Form.Item name={['paper', 'reviewer_id']} rules={[{required: true, message: '请输入阅卷人编号!'}]}
                           label="阅卷人编号">
